<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkout_3.aspx.cs" Inherits="xehardiversity.checkout_3" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="checkout_steps_area">
                        <a class="" href="#"><i class="ion-ios-checkmark"></i></a>
                        <a class="complated" href="checkout_2.aspx"><i class="ion-ios-checkmark"></i> SHIPPING ADDRESS</a>
                        <a class="active" href="checkout_3.aspx"><i class="ion-ios-checkmark"></i> Shipping Method</a>
                        <a class="" href="#" onclick="ProcessShipping();"><i class="ion-ios-checkmark"></i> Payment</a>
                        <a class="" href="checkout_5.aspx"><i class="ion-ios-checkmark"></i> Review</a>
                        <a class="" href="#"><i class="ion-ios-checkmark"></i></a>
                    </div>
                </div>
                        ...
                        <div class="shipping_method">
                            <form action="#" method="post" runat="server">
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="col-4">Expedited</td>
                                            <td class="col-4">1-2 Business Days</td>
                                            <td class="col-3">$20.99</td>
                                            <td class="col-1">
                                                <label class="custom-control custom-radio">
                                                    <input id="expedited" value="20.99" name="radio" type="radio" class="custom-control-input" runat="server">
                                        ...
                                        <tr>
                                            <td class="col-4">Flat Rate</td>
                                            <td class="col-4">3-4 Business Days</td>
                                            <td class="col-3">$4.95</td>
                                            <td class="col-1">
                                                <label class="custom-control custom-radio">
                                                    <input id="flat" value="4.95" name="radio" type="radio" class="custom-control-input" runat="server">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description"></span>
                                                </label>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="col-4">International Flat Rate</td>
                                            <td class="col-4">5-7 Business Days</td>
                                            <td class="col-3">$15.99</td>
                                            <td class="col-1">
                                                <label class="custom-control custom-radio">
                                                    <input id="internationalFlat" value="15.99" name="radio" type="radio" class="custom-control-input" runat="server">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description"></span>
                                                </label>
                                            </td>
                                ...
                                <div style="display: none;">
                                    <asp:Button runat="server" ID="ShippingCost" OnClick="AddShipping" />
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="checkout_pagination mt-50 clearfix">
                        <a href="checkout_2.aspx">Go Back</a>
                        <a href="#" onclick="ProcessShipping();">Continue</a>
                    </div>
                </div>
            </div>
        </div>
