<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkout_complete.aspx.cs" Inherits="xehardiversity.checkout_complete" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="order_complated_area clearfix">
                        ...
                        <p class="orderid">Your Order id # <asp:Label ID="lblOrderId" runat="server" Text=""></asp:Label></p>
                ...
                <div class="col-12">
                    <div class="checkout_pagination mt-50">
                        <a href="shop.aspx">Go Back Shop</a>
                    </div>
                </div>
            </div>
        </div>
